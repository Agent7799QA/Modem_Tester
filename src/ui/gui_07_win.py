...
"}")
        ...
        self.layoutWidget1.setGeometry(QRect(10, 60, 961, 280))
        ...
        self.rx_max_rssi_label = QLabel(self.layoutWidget1)
        ...
        self.rx_min_rssi_label = QLabel(self.layoutWidget1)
        ...
        self.rx_max_lq_label = QLabel(self.layoutWidget1)
        ...
        self.rx_min_lq_label = QLabel(self.layoutWidget1)
        ...
        self.rx_max_rssi_lcd = QLCDNumber(self.layoutWidget1)
        ...
        self.rx_min_rssi_lcd = QLCDNumber(self.layoutWidget1)
        ...
        self.rx_max_lq_lcd = QLCDNumber(self.layoutWidget1)
        ...
        self.rx_min_lq_lcd = QLCDNumber(self.layoutWidget1)
        ...
        self.tx_max_rssi_label = QLabel(self.layoutWidget1)
        ...
        self.tx_min_rssi_label = QLabel(self.layoutWidget1)
        ...
        self.tx_max_lq_label = QLabel(self.layoutWidget1)
        ...
        self.tx_min_lq_label = QLabel(self.layoutWidget1)
        ...
        self.tx_max_rssi_lcd = QLCDNumber(self.layoutWidget1)
        ...
        self.tx_min_rssi_lcd = QLCDNumber(self.layoutWidget1)
        ...
        self.tx_max_lq_lcd = QLCDNumber(self.layoutWidget1)
        ...
        self.tx_min_lq_lcd = QLCDNumber(self.layoutWidget1)
        ...
        self.layoutWidget2 = QWidget(self.Statistic_frame)
        self.layoutWidget2.setObjectName(u"layoutWidget2")
        self.layoutWidget2.setGeometry(QRect(0, 0, 981, 63))
        self.horizontalLayout_10 = QHBoxLayout(self.layoutWidget2)
        self.horizontalLayout_10.setObjectName(u"horizontalLayout_10")
        self.horizontalLayout_10.setContentsMargins(0, 0, 0, 0)
        self.stat_coll_label = QLabel(self.layoutWidget2)
        ...
        self.start_coll_btn = QPushButton(self.layoutWidget2)
        ...
        self.start_coll_btn.setFont(font2)

        self.horizontalLayout_10.addWidget(self.start_coll_btn)

        self.clear_coll_btn = QPushButton(self.layoutWidget2)
        ...
        self.timer_lcd = QLCDNumber(self.layoutWidget2)
        ...
        self.layoutWidget3.setGeometry(QRect(10, 50, 971, 98))
        self.verticalLayout_9 = QVBoxLayout(self.layoutWidget3)
        self.verticalLayout_9.setObjectName(u"verticalLayout_9")
        self.verticalLayout_9.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_8 = QHBoxLayout()
        self.horizontalLayout_8.setObjectName(u"horizontalLayout_8")
        self.ch1_label = QLabel(self.layoutWidget3)
        ...
        self.ch2_label = QLabel(self.layoutWidget3)
        ...
        self.ch3_label = QLabel(self.layoutWidget3)
        ...
        self.ch4_label = QLabel(self.layoutWidget3)
        ...
        self.ch5_label = QLabel(self.layoutWidget3)
        ...
        self.ch6_label = QLabel(self.layoutWidget3)
        ...
        self.ch7_label = QLabel(self.layoutWidget3)
        ...
        self.ch8_label = QLabel(self.layoutWidget3)
        ...
        self.ch9_label = QLabel(self.layoutWidget3)
        ...
        self.ch10_label = QLabel(self.layoutWidget3)
        ...
        self.ch11_label = QLabel(self.layoutWidget3)
        ...
        self.ch12_label = QLabel(self.layoutWidget3)
        ...
        self.ch13_label = QLabel(self.layoutWidget3)
        ...
        self.ch14_label = QLabel(self.layoutWidget3)
        ...
        self.ch15_label = QLabel(self.layoutWidget3)
        ...
        self.ch16_label = QLabel(self.layoutWidget3)
        ...
        self.ch1_lineEdit = QLineEdit(self.layoutWidget3)
        ...
        self.ch1_lineEdit.setMaximumSize(QSize(60, 41))
        font4 = QFont()
        font4.setPointSize(16)
        self.ch1_lineEdit.setFont(font4)
        self.ch1_lineEdit.setMaxLength(4)

        self.horizontalLayout_7.addWidget(self.ch1_lineEdit)

        self.ch2_lineEdit = QLineEdit(self.layoutWidget3)
        ...
        self.ch2_lineEdit.setMaximumSize(QSize(60, 41))
        self.ch2_lineEdit.setFont(font4)
        self.ch2_lineEdit.setMaxLength(4)

        self.horizontalLayout_7.addWidget(self.ch2_lineEdit)

        self.ch3_lineEdit = QLineEdit(self.layoutWidget3)
        ...
        self.ch3_lineEdit.setMaximumSize(QSize(60, 41))
        self.ch3_lineEdit.setFont(font4)
        self.ch3_lineEdit.setMaxLength(4)

        self.horizontalLayout_7.addWidget(self.ch3_lineEdit)

        self.ch4_lineEdit = QLineEdit(self.layoutWidget3)
        ...
        self.ch4_lineEdit.setMaximumSize(QSize(60, 41))
        self.ch4_lineEdit.setFont(font4)
        self.ch4_lineEdit.setMaxLength(4)

        self.horizontalLayout_7.addWidget(self.ch4_lineEdit)

        self.ch5_lineEdit = QLineEdit(self.layoutWidget3)
        ...
        self.ch5_lineEdit.setMaximumSize(QSize(60, 41))
        self.ch5_lineEdit.setFont(font4)
        self.ch5_lineEdit.setMaxLength(4)

        self.horizontalLayout_7.addWidget(self.ch5_lineEdit)

        self.ch6_lineEdit = QLineEdit(self.layoutWidget3)
        ...
        self.ch6_lineEdit.setMaximumSize(QSize(60, 41))
        self.ch6_lineEdit.setFont(font4)
        self.ch6_lineEdit.setMaxLength(4)

        self.horizontalLayout_7.addWidget(self.ch6_lineEdit)

        self.ch7_lineEdit = QLineEdit(self.layoutWidget3)
        ...
        self.ch7_lineEdit.setMaximumSize(QSize(60, 41))
        self.ch7_lineEdit.setFont(font4)
        self.ch7_lineEdit.setMaxLength(4)

        self.horizontalLayout_7.addWidget(self.ch7_lineEdit)

        self.ch8_lineEdit = QLineEdit(self.layoutWidget3)
        ...
        self.ch8_lineEdit.setMaximumSize(QSize(60, 41))
        self.ch8_lineEdit.setFont(font4)
        self.ch8_lineEdit.setMaxLength(4)

        self.horizontalLayout_7.addWidget(self.ch8_lineEdit)

        self.ch9_lineEdit = QLineEdit(self.layoutWidget3)
        ...
        self.ch9_lineEdit.setMaximumSize(QSize(60, 41))
        self.ch9_lineEdit.setFont(font4)
        self.ch9_lineEdit.setMaxLength(4)

        self.horizontalLayout_7.addWidget(self.ch9_lineEdit)

        self.ch10_lineEdit = QLineEdit(self.layoutWidget3)
        ...
        self.ch10_lineEdit.setMaximumSize(QSize(60, 41))
        self.ch10_lineEdit.setFont(font4)
        self.ch10_lineEdit.setMaxLength(4)

        self.horizontalLayout_7.addWidget(self.ch10_lineEdit)

        self.ch11_lineEdit = QLineEdit(self.layoutWidget3)
        ...
        self.ch11_lineEdit.setMaximumSize(QSize(60, 41))
        self.ch11_lineEdit.setFont(font4)
        self.ch11_lineEdit.setMaxLength(4)

        self.horizontalLayout_7.addWidget(self.ch11_lineEdit)

        self.ch12_lineEdit = QLineEdit(self.layoutWidget3)
        ...
        self.ch12_lineEdit.setMaximumSize(QSize(60, 41))
        self.ch12_lineEdit.setFont(font4)
        self.ch12_lineEdit.setMaxLength(4)

        self.horizontalLayout_7.addWidget(self.ch12_lineEdit)

        self.ch13_lineEdit = QLineEdit(self.layoutWidget3)
        ...
        self.ch13_lineEdit.setMaximumSize(QSize(60, 41))
        self.ch13_lineEdit.setFont(font4)
        self.ch13_lineEdit.setMaxLength(4)

        self.horizontalLayout_7.addWidget(self.ch13_lineEdit)

        self.ch14_lineEdit = QLineEdit(self.layoutWidget3)
        ...
        self.ch14_lineEdit.setMaximumSize(QSize(60, 41))
        self.ch14_lineEdit.setFont(font4)
        self.ch14_lineEdit.setMaxLength(4)

        self.horizontalLayout_7.addWidget(self.ch14_lineEdit)

        self.ch15_lineEdit = QLineEdit(self.layoutWidget3)
        ...
        self.ch15_lineEdit.setMaximumSize(QSize(60, 41))
        self.ch15_lineEdit.setFont(font4)
        self.ch15_lineEdit.setMaxLength(4)

        self.horizontalLayout_7.addWidget(self.ch15_lineEdit)

        self.ch16_lineEdit = QLineEdit(self.layoutWidget3)
        ...
        self.ch16_lineEdit.setMaximumSize(QSize(60, 41))
        self.ch16_lineEdit.setFont(font4)
        ...
        self.layoutWidget4.setGeometry(QRect(10, 0, 612, 54))
        self.horizontalLayout_9 = QHBoxLayout(self.layoutWidget4)
        self.horizontalLayout_9.setObjectName(u"horizontalLayout_9")
        self.horizontalLayout_9.setContentsMargins(0, 0, 0, 0)
        self.emulate_command_label = QLabel(self.layoutWidget4)
        ...
        self.rate_lineEdit = QLineEdit(self.layoutWidget4)
        ...
        self.start_emulation = QPushButton(self.layoutWidget4)
        ...
        self.start_emulation.setFont(font2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.start_coll_btn.setText(QCoreApplication.translate("MainWindow", u"Collect", None))
